...
Install manually using the guide below. macOS users have a simpler path: download the [DMG file](../../releases).


# Installation+Run🕸
```shell
git clone https://github.com/versiaever/Pharos-Testnet-Bot
